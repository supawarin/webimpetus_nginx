   ...
   <!--------------  print invoice from timeslip --------------------------->

   <div class="modal fade" id="invoiceTimeslip" tabindex="-1" role="dialog" aria-labelledby="invoiceTimeslipLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
           <div class="modal-content">
               <div class="modal-header">
                    <h5 class="modal-title" id="invoiceTimeslipLabel">Create New Invoice From Timeslipt</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
               </div>
               <form action="<?php echo base_url("timeslips/invoiceTimeslipPDF"); ?>" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="employeeTimeslip">Employee</label>
                            <select name="employee" class="form-control" id="employeeTimeslip">
                                <option value="-1" selected>All</option>
                                <?php foreach(@$employees as $employee){?>
                                   <option value="<?php echo $employee["id"]; ?>"><?php echo $employee["name"];?></option>
                                <?php } ?>
